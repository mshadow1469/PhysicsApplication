...
//Grava inherits properties from JavaFx Application Class
    ...
    TextField gradientField = new TextField();
    TextField corField = new TextField();
    CheckBox cb = new CheckBox("Trend");
    ...
    public void start(Stage stage) {
        ...
        // creates g object of XYItemRenderer
...
//////////
        ...
        var deleteButton = new Button("clear selected value");
        ...
        var xSpin = new Spinner(-1_000_000.000, 1_000_000.000,0 , 0.1);
        xSpin.setEditable(true);
        xSpin.setPromptText("Xvalue");

        var ySpin = new Spinner(-1_000_000.000, 1_000_000.000, 0, 0.1);
        ...
        series.addChangeListener((event) -> {
            double spinX = (double) xSpin.getValue();
            double spinY = (double) ySpin.getValue();
                //if Character.isDigit(xSpin.getValue()){
        ...
        addButton.setOnAction(ae -> {
            ...
            xList.add(spinX);
            yList.add(spinY);
            testModel.add(new tableClass(spinY, spinX));
            ...
            if (series.getItemCount() > 1){
                ...
                float formatCor = Float.parseFloat(df.format(cor));
                float formatM = Float.parseFloat(df.format(m));
                ...
                corField.setText(String.valueOf(formatCor));
        ...
        deleteButton.setOnAction(ae -> {
            ...
            if (itemSelected != null){// condition to check if an item is selected
    ...
    private void clearList(){
        ...
        if(answer) {
            ...
            gradientField.setText("Gradient");
            corField.setText("r-Value");
            // if the answer = true then the series,trend, testmodel list is cleared and all textFields are cleared
        }
    }
